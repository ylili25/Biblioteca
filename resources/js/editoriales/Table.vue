            ...
            >
                <div class="text-center align-middle actions">
                    <a
                        ...
                        data-toggle="tooltip"
                        title="Editar"
                        :href="`/editoriales/${props.rowData.id}/edit`"
                    >
                        Editar
                    </a>
                    <button
...
export default {
    ...
    methods:{
        ...
        async deleteRow(editorial_id) {
            try {
                let response = await axios.delete(`/editoriales/${editorial_id}`)
                ...
                this.alerta.texto = 'No se pudo eliminar la editorial'
            }
        },
